...
Поточна фаза: ✅ ПІДГОТОВКА до ЕТАП 2

В ETAP 2 буде реалізовано:
  • 3 повнофункціональні ролі (Admin, Client, Courier)
  • Система замовлення доставки від клієнтів
  • Алгоритм розумної маршрутизації (пошук найближчих курйерів в радіусі 5км)
  • GPS відстеження доставки
  • Автоматичний розрахунок вартості доставки
  • Система оцінок та відзивів
  • Admin панель зі статистикою та картою всіх курйерів

Файли планування:
  • ETAP2_PLAN.md - детальний план розвитку
  • ETAP2_ARCHITECTURE.md - архітектура та дизайн системи
